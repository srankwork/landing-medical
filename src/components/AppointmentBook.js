...
const BookAppointment = ({ forModal }) => {
  ...
  const handleFindOutClick = () => {
    if (validateInput()) {
      ...
      }&Mobile=${phone}&Email=${email}&LEADCF1=${service}&returnURL=https://www.novacutisclinics.com/services/thankyou/laser-hair-removal/index.html`;
      ...
      fetch('https://crm.zoho.in/crm/WebToLeadForm', requestOptions)
        ...
        .then((result) => {
          window.location.assign(
            'https://www.novacutisclinics.com/services/thankyou/laser-hair-removal/index.html'
          );
        })
