...
const ServiceIntroduction = () => {
  ...
  return (
    <section className="relative md:flex bg-appointment-btn mt-14 md:mt-28">
      <div
        className="hidden md:block w-1/2 h-60 md:h-screen bg-cover bg-no-repeat bg-center relative"
        style={{
      ...
      <div className="w-full md:w-1/2 p-10 text-white">
        ...
        <p className="mt-4 md:mt-6 text-lg">
          ...
          finibus nunc. Aliquam erat volutpat. Sed ac pulvinar sapien. Sed
          volutpat nunc, eu efficitur ipsum vulputate finibus.
        </p>
        ...
        <ul class="list-none p-0 md:mt-12">
          {serviceList.map((e) => (
            <li
              key={e}
              class="mb-4 md:mb-8 flex items-center group hover:text-red-500 transition-transform transform hover:translate-x-2 cursor-default text-xl"
            >
